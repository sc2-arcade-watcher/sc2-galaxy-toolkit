...
import { Store, S2WorkspaceWatcher, createTextDocumentFromFs, openSourceFilesInLocation } from '../src/galaxy/store.js';
import { SC2Workspace } from '../src/galaxy/workspace.js';
